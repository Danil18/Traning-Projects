...
class Order {
    ...
    public static function getOrderList(){
        ...
        $orderList = array();
        // Текст запроса к БД
        $sql = 'SELECT id, user_name, user_phone, date, status FROM '
    ...
    public static function getUserOrdersList($userId){
        ...
        $orderList = array();
        // Текст запроса к БД
        $sql = 'SELECT id, date, products, status FROM product_order '
     ...
     * @return integer <p>Общая цена товаров</p>
     */
    public static function getTottalPriceInOrder($id){
        ...
        // Ищем общуюю цену за все товары в заказе
        $total = 0;
